#!/usr/bin/env node
/**
 * Adds birthday, age, field_count, and main_crop to public.profiles.
 *   npm run db:migrate-farmer-background-details
 */
...
const migrationSql = readFileSync(join(root, 'supabase/add-farmer-background-details.sql'), 'utf8');
